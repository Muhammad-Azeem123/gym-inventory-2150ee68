...
import { Package, ShoppingCart, TrendingUp, AlertTriangle, Eye, LogOut } from "lucide-react";
...
export const GymDashboard = () => {
  ...
  useEffect(() => {
    if (selectedCategory === "all") {
      ...
      setFilteredStock(currentStock.filter(item => item.category === selectedCategory));
    }
  }, [currentStock, selectedCategory]);
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-primary/5 via-background to-secondary/5 p-4 md:p-6">
      ...
      {/* Action Buttons */}
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-6 mb-8">
        <Card className="border-0 shadow-lg bg-gradient-to-r from-primary/10 to-primary/5 hover:from-primary/15 hover:to-primary/10 transition-all duration-300">
          <CardContent className="p-4 md:p-6">
            <div className="flex flex-col gap-3">
              <div>
                <h3 className="text-lg md:text-xl font-semibold text-foreground mb-2">Add Purchase</h3>
        ...
        <Card className="border-0 shadow-lg bg-gradient-to-r from-secondary/10 to-secondary/5 hover:from-secondary/15 hover:to-secondary/10 transition-all duration-300">
          <CardContent className="p-4 md:p-6">
            <div className="flex flex-col gap-3">
              <div>
                <h3 className="text-lg md:text-xl font-semibold text-foreground mb-2">New Sale</h3>
                <p className="text-sm text-muted-foreground">Record a new product sale</p>
              </div>
              <Button 
        ...
        <Card className="border-0 shadow-lg bg-gradient-to-r from-accent/10 to-accent/5 hover:from-accent/15 hover:to-accent/10 transition-all duration-300">
          <CardContent className="p-4 md:p-6">
            <div className="flex flex-col gap-3">
              <div>
                <h3 className="text-lg md:text-xl font-semibold text-foreground mb-2">View Products</h3>
